...
function gateHTML() {
  return `<div class="gate"><h1>Supply</h1><p>The buying brain for Lucky Golf. Sign in with your Mobius Google account, or the dashboard password.</p>
    <a class="cta" href="../hq/?next=/supply/">Continue with Google</a>
    <div class="or">or</div>
