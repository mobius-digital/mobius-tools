...
export default async function PasswordPage({
  ...
  // Only ever redirect back to a path on this site; home is this brand's
  // board, not the hub's front door.
  ...
  // Google is the front door whenever the hub has a client ID; the team
  // password sits alongside for brands that use one.
  const googleMode = Boolean(config.googleClientId);
  const passwordAvailable = configured;
