...
export function EventTypesPanel() {
  ...
  const send = useCallback(
    async (payload: Record<string, unknown>) => {
      ...
      try {
        const response = await fetch(path("/api/settings/types"), {
          method: "POST",
  ...
  // A half-typed new type, or a rename left open, is worth warning about.
  useReportDirty("event-types", Boolean(newLabel.trim()) || editingKey !== null);
